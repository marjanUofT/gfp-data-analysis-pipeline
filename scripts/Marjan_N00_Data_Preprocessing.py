...
class DataProcessor:
    def __init__(self, binary_class_bool, data_folder, target_nme, data_file, data_file_binary,
                 max_seqs_len, y_prpty_cls_threshold, output_folder, output_file_0, output_file_1):
        self.binary_class_bool = binary_class_bool
        self.data_folder = data_folder
        self.target_nme = target_nme
        self.data_file = data_file
        self.data_file_binary = data_file_binary
        self.max_seqs_len = max_seqs_len
        self.y_prpty_cls_threshold = y_prpty_cls_threshold
        self.output_folder = output_folder
        self.output_file_0 = output_file_0
        self.output_file_1 = output_file_1
        
        
    # def N00_Data_Processing(self, binary_class_bool      ,
    #                         data_folder            ,
    #                         target_nme             , 
    #                         data_file              ,
    #                         data_file_binary       ,
    ...
    def N00_Data_Processing(self, binary_class_bool      ,
        ...
        #--------------------------------------------------#
        # Output #1: Write a fasta file including all sequences
        seqs_list = output_fasta(processed_data_df, output_folder, output_file_0,max_seqs_len)
...
#                         "mcmc_AVGFP"       : ["quantitative_function"  , "./GFP/mcmc_AVGFP_uniqSeq.csv"               ,   1200, ],  # 3
#                         "Rubisco"          : ["Kcatmean"              , "./Rubisco.csv"                               ,   1200, ],  # 4
#                         ""                 : [""                       , ""                                           ,   1200, ],  # 4
#                        }
